//reference of bfs:https://www.geeksforgeeks.org/shortest-path-unweighted-graph/
#include <iostream>
#include <sstream>
		...
		while (getline(cin, arr)) {
            ...
            if (arr[0] == 's') {
                if(E_vec.size() == 0 || vertex ==0){
                    cerr<<"Error: E_vec and Vertex are empty"<<endl;
                }
                else{
                vector <int> s_vec;				
				vector<char> new_vec;
            ...
            //if first element of arr is V
				...
				while (vertex == 0) {
					cerr << "Error: NO vertex is entered." << endl;
					//break;
				}
				//break;
			}
            ...
            //EEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEE
				...
				//cout << line << endl;//a3: edit it to print the graph that it has read before accepting an s command.
				if(arr.length()<5){
                    cerr<<"Error: empty edge and vertcies"<<endl;
                }
                else{
                for (int i = 0; arr[i] != '\0'; i++) {
					if (arr[i] > '0' && arr[i] <= '9') {
                ...
                int maxi = 0;
                maxi = *max_element(E_vec.begin(), E_vec.end());
